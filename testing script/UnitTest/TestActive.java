...
public class TestActive {
    ...
    @Test
    public void testIsActive01() {
        boolean expected = false;
        boolean actual = managedBean.isValidActive(null);
        assertEquals(expected, actual);
    }

    @Test
    public void testIsActive02() {
        boolean expected = true;
        boolean actual = managedBean.isValidActive(true);
        assertEquals(expected, actual);
    }

    @Test
    public void testIsActive03() { // test a thing
        boolean expected = true;
        boolean actual = managedBean.isValidActive(false);
        assertEquals(expected, actual);
    }
