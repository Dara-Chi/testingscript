...
public class TestAppgroup {
    ...
    @Test
    public void testIsValidAppgroup01() {
        boolean expected = false;
        String adminGroup = "";
        boolean actual = managedBean.isValidAppgroup(adminGroup);
        assertEquals(expected, actual);

    }

    @Test
    public void testIsValidAppgroup02() {
        boolean expected = false;
    ...
    @Test
    public void testIsValidAppgroup03() {
        boolean expected = false;
        String adminGroup = "ED-EMS-NONE";
        boolean actual = managedBean.isValidAppgroup(adminGroup);
        assertEquals(expected, actual);
    ...
    @Test
    public void testIsValidAppgroup04() {
        boolean expected = false;
        String adminGroup = "#";
        boolean actual = managedBean.isValidAppgroup(adminGroup);
        assertEquals(expected, actual);
    ...
    @Test
    public void testIsValidAppgroup05() {
        boolean expected = true;
        String adminGroup = "ED-EMS-ADMIN";
        boolean actual = managedBean.isValidAppgroup(adminGroup);
        assertEquals(expected, actual);
    }

    @Test
    public void testIsValidAppgroup06() {
        boolean expected = true;
        String adminGroup = "ED-EMS-USERS";
        boolean actual = managedBean.isValidAppgroup(adminGroup);
        assertEquals(expected, actual);
    }
}
